    ...
    const getAllPosts = async () => {
      try {
        ...
        const response = await axios.get(
          `${nu_api_base_url}/retsepile/66454198384658227e748c6e`,
          {
  ...
  async function updateRetsepilePostComment(postId: string): Promise<void> {
    try {
      ...
      const response = await axios.put(
        `${nu_api_base_url}/retsepile/${postId}`,
        body
      );
      console.log(`Post ${postId} updated successfully.`);
  ...
  return (
    <main>
      ...
      <div className="flex w-full  gap-3 justify-center lg:top-5   items-center lg:h-full h-[120%] fixed bottom-7">
        ...
        >
          <div
            className="lg:w-[60%] sm:w-[100%] h-full p-2 "
            style={{
              borderWidth: "1px",
              borderTopWidth: "0px",
          ...
          >
            ...
            >
              ...
              {!isDesktop && (
                <div className="p-5 mt-48 lg:mt-0">
              ...
              <ScrollArea
                ...
                className="h-[100%] flex flex-col gap-5 w-full rounded-md border p-4"
              >
                <div className="flex flex-col gap-5">
                  <Card className="w-[100%]" id="blogging">
                    <CardHeader>
                      ...
                      <CardDescription>
                        ...
                        <br />
                        The process of creating instructions for computers to
                        perform tasks.
                        <br />
                        It involves code using <b>programming languages</b>
                        <br />
                        <br />
                        <b>Programming language</b> is a set of syntax and rules
                        that computers can understand and execute
                        <br />
                        <br />
                        <b>In layman&apos;s terms</b>
                        <br />
                        It is a language through which humans communicate with
                        computers to make them do what they want.
                        <br />
                        <br />
                        <div className="flex gap-3">
                          <Badge className="pb-1">read more ...</Badge>
                          <Link
                            href={
                              "https://youtu.be/MfajJFQ0bj4?si=arotPAnkR_-sh5JD"
                            }
                          >
                            <YoutubeIcon />
                          </Link>
                                        ...
                                        <HoverCardContent>
                                          <p
                                            style={{
                                              fontSize: 12,
                                              color:
                                                "rgba(255, 255, 255, 0.716)",
                                            }}
                                          >
                                            This message will only be seen by a
                                            person or a group of people you send
                                            a temp-on token to{" "}
                                          </p>
                                        </HoverCardContent>
                                      </HoverCard>
                  ...
                  <Card className="w-[100%] p-0.5 pl-3 ">
                    <div>
                      <CardHeader>
                        <CardTitle>
                          Psychedelic collection of consciousness
                        </CardTitle>
                        <CardDescription>
                          Whats crazy is the extension of our personal and
                          collective minds, us putting out ideas (Ridic
                          Originals, Nucleus Creative Studio) beliefs and
                          opinions that form a digital society, culture(Daeman.)
                          and the world. This is a psychedelic collection of
                          consciousness.
                        </CardDescription>
                      </CardHeader>
                  ...
                  <Card className="w-[100%]">
                    <CardHeader>
                      ...
                      <CardDescription>
                        The worst mistake you can make is to think Lesotho has
                        no skills. If you think so, it&apos;s probably because
                        you&apos;ve been spending too much time in your bedroom
                        rather than networking. Go outside, and I swear you will
                        be amazed.
                      </CardDescription>
                    </CardHeader>
                    <Image
                  ...
                  <Card className="w-[100%]" id="storms">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Today, I&apos;ll be featured at Bokamoso FM radio, one
                        of the topics ama touch on is how the next Solar storm
                        is going affect our internet activities, what&apos;s
                        crazy is, Nasa had predicted that this will happen in
                        2025, but it could actually happen this year. Imagine
                        the whole wide world without the internet for weeks 😳.
                        This not a science phenomenon or myth, it&apos;s highly
                        possible
                      </CardDescription>
                    </CardHeader>
                    <Image

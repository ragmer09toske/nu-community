                ...
                <div className="flex flex-col gap-5">
                      ...
                      <CardDescription>
                        ...
                        <div className="flex gap-3">
                          <Badge className="pb-1">
                            <a href="/retsepile/programming">read more</a>
                          </Badge>
                          <Link
                            href={
                  ...
                  <Card className="w-[100%] p-0.5 pl-3 ">
                    <div>
                      <CardHeader>
                        ...
                        <CardDescription>
                          ...
                          analyzing and manipulating data. It provides
                          high-level data structures and various tools for
                          working with structured data.
                          <br />
                          What do I mean by <b>high-level data structures?</b>
                          <br />
                          <br />
                          By <b>high-level data structures</b>, I mean it offers
                          powerful data containers that simplify complex data
                    ...
                    <div className="flex gap-3 p-5">
                      <Badge className="pb-1">
                        <a href="/retsepile/pandas">read more</a>
                      </Badge>
                      <Link
                        href={
                          "https://youtu.be/MfajJFQ0bj4?si=arotPAnkR_-sh5JD"

...
export default function Navbar_Data_Repo() {
  ...
  const Brand = () => (
    <div className="flex items-center justify-between py-5 md:block">
      <a href="javascript:void(0)">
        <Image src="/nu.png" width={40} height={10} alt="Float UI logo" />
      </a>
  ...
  return (
    <nav
      className={`pb-5 z-[9999] pt-10 md:text-sm ${
        state
    ...
    >
      <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
        <Brand />
        <div
          className={`flex-1 items-center mt-16 md:mt-0 md:flex ${
            state ? "block" : "hidden"
          } `}
        >
            ...
            >
              <DialogPanel>
                ...
                <p className="mt-2 leading-6 text-tremor-default text-tremor-content dark:text-dark-tremor-content">
                  ...
                  to your account. For more information, please contact us.
                </p>
                {!UserDetails && (
                  <Button
                    className="mt-8 w-full flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex"

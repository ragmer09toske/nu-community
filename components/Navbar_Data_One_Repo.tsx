        ...
        <div className="items-center justify-end mt-6 space-y-6 md:flex md:mt-0">
            <Dialog open={isOpen} onClose={(val) => setIsOpen(val)} static={true}>
                <DialogPanel>
                    ...
                    {!UserDetails && <Button className="mt-8 w-full flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex" onClick={() => setIsOpen(false)}>
                        Sign in

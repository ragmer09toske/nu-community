    ...
    <div className='lg:w-[60%]  sm:w-[100%] h-full p-2 ' style={{
      ...
      <Command className="rounded-lg border shadow-md" style={{ background: "rgba(255, 255, 255, 0)", borderWidth: "0px"}}>
        ...
        {!isDesktop && <div className="p-5 justify-center mt-36 lg:mt-0">
          <div className='pb-10'>
            <div className='z-50 fixed w-[90.5%] border p-5 flex gap-2 -mt-10 -ml-2 justify-center rounded' style={{ backgroundImage: "url('/code.jpg')", backgroundSize: "cover" }}>
              <div className='flex'>
                <Image
                  src="/nu.png"
                  alt="Nucleus Logo"
        ...
        <ScrollArea style={{borderWidth: "0px"}} className="h-[100%] flex flex-col gap-5 w-full rounded-md border">
